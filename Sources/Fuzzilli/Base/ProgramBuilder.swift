...
public class ProgramBuilder {
    ...
    @discardableResult
    public func instantiateWasmModule(_ module: Variable, withImports imports: [Variable] = [])
        -> Variable
    {
        return emit(InstantiateWasm(numImports: imports.count), withInputs: [module] + imports)
            .output
    }
